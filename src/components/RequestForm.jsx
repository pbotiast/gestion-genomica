...
const RequestForm = ({ onSubmit, onCancel, initialData }) => {
    ...
    // Note: registrationNumber is now auto-generated by backend (YYYY-XXXX format)
    const [formData, setFormData] = useState(initialData || {
        // registrationNumber is auto-generated, not set here
        ...
        finalSamplesCount: '',
        additionalInfo: '',
        orderNumber: '', // New field for purchase order number
        requestedBy: '',
        resultSentDate: '',
        technician: '',
        institution: '',
        ...
        <form onSubmit={handleSubmit} className={styles.form}>
            <div className={styles.section}>
                <div className={styles.grid3}>
                    {/* Show registrationNumber only when editing, as it's auto-generated */}
                    {initialData && formData.registrationNumber && (
                    ...
                    {!initialData && (
                        <div className={styles.inputGroup}>
                            <label>Nº Registro</label>
                            <input readOnly value="Autogenerado al guardar" className="bg-slate-700/50 cursor-not-allowed italic text-gray-400" />
                        </div>
                    )}
                    <div className={styles.inputGroup}>
